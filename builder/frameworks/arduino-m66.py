...
def dev_init(env):
    ...
    env.Append(
        ...
        CPPPATH    = [
            ...
            join(env.framework_dir, 'arduino', 'variants', env.variant),  
    ...
    env.BuildSources( join('$BUILD_DIR', 'arduino', 'arduino'), join(env.framework_dir, 'arduino', 'arduino') )
    env.BuildSources( join('$BUILD_DIR', 'arduino', 'core'), join(env.framework_dir, 'arduino', 'cores', env.core) )
    env.BuildSources( join('$BUILD_DIR', 'arduino', 'variant'), join(env.framework_dir, 'arduino', 'variants', env.variant) )